...
$sql = "select * from hod limit ".$start.",".$perPage."";
$total = $db->query("select * from hod")->num_rows;
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container">
      <div class="row" style="margin-top: 70px;">
        <h1 style="text-align:center;">Head Of Departments</h1>
        <div class="col-md-10  ">
          <table class="table table-hover" style="width:100%;">
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal">Add HoD</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="addHod.php">
          <div class="form-group">
            ...
            <label>Faculty</label>
            <input type="number" required name="faculty" class="form-control">
        ...
        <input type="submit" name="send" value="Save changes"  class="btn btn-primary">
            ...
            <tbody>
              <tr>
                ...
                <th scope="row"><?php echo $row['hodID']?></th>
                <td ><?php echo $row['email']?></td>
                <td ><?php echo $row['firstName']?></td>
                <td ><?php echo $row['lastName']?></td>
                <td ><?php echo $row['role']?></td>
                <td ><?php echo $row['facID']?></td>
                <td ><a href="updateHod.php?id=<?php echo $row['hodID'];?>" class="btn btn-success">Edit</a></td>
                <td ><a href="deleteHoD.php?id=<?php echo $row['hodID'];?>" class="btn btn-danger">Delete</a></td>
                </tr> 
                <?php endwhile; ?>
